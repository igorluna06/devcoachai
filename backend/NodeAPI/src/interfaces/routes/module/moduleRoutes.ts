...
router.post(moduleEndpoints.GENERATE + moduleEndpoints.BY_ID, (req, res, next) => moduleController.generateModules(req, res, next));
...
router.patch(moduleEndpoints.ROOT, (req, res, next) => moduleController.updateModule(req, res, next));
