...
import { mapModule } from '../../../infrastructure/mappers/StudyPlanMapper'
...
export default function StudyPlanDetailPage() {
    ...
    useEffect(() => {
        ...
        api
            ...
            .then((res) => setModules((res.data || []).map(mapModule)))
            .catch(() => {})
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-3">
                {loading ? (
                    ...
                    <div className="text-center py-8 text-[#888888]">Nenhum módulo encontrado.</div>
                ) : (
                    modules.map((m) => (
                        <Link
                            key={m.id}
                            ...
                            className={`group flex items-center gap-4 p-4 rounded-xl border-2 transition ${
                                m.isLocked
                                    ? 'border-[#1a1a1a] bg-black/30 opacity-50 cursor-not-allowed pointer-events-none'
                                    : m.isCompleted
                        ...
                        >
                            ...
                            <div className="flex-1">
                                ...
                                {m.order && (
                                    <div className="text-xs text-[#888888] mt-1">Módulo {m.order}</div>
                                )}
                            </div>
